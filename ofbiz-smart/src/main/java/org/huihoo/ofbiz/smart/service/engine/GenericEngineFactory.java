...
public class GenericEngineFactory {
  protected volatile ServiceDispatcher dispatcher = null;
  protected volatile Map<String, GenericEngine> engines = new HashMap<>();;
   ...
   * @return <code>GenericEngine</code>
      ...
      synchronized (GenericEngineFactory.class) {
        ...
        if (engine == null) {
          try {
            ...
            throw new GenericServiceException("getGenericEngine Exception", e);
          }
