...
/**
 * Allows managing a mapping of alias to the session id for having multiple active sessions at the
 * same time.
 *
 * @author Rob Winch
 * @since 1.0
...
public interface HttpSessionManager {
   ...
   * @return a mapping of the session alias to the session id from the {@link HttpServletRequest}.
   *         Cannot be null.
   */
