...
public class SimpleCacheManager {
  ...
  static {
      cacheProviderName = AppConfigUtil.getProperty(C.CACHE_PROVIDER_NAME, "org.huihoo.ofbiz.smart.base.cache.DefaultCache");
      timeToLiveSeconds = Integer.parseInt(AppConfigUtil.getProperty(C.CACHE_DEFAULT_TIMETOLIVESECONDS, "60"));
      maxEntries = Integer.parseInt(AppConfigUtil.getProperty(C.CACHE_DEFAULT_MAXENTRIES, "1024"));
