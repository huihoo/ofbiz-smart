...
public class UrlValidator implements ConstraintValidator<Url, CharSequence> {
  ...
  public static final java.util.regex.Pattern IP_ADDRESS =
      java.util.regex.Pattern.compile("((25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}|[1-9][0-9]|[1-9])\\.(25[0-5]|2[0-4]"
  ...
  public static final java.util.regex.Pattern WEB_URL = java.util.regex.Pattern
