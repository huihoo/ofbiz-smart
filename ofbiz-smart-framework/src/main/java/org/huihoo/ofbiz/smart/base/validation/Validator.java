...
public class Validator {
    ...
    private final static Map<Class<? extends Annotation>, List<? extends Class<?>>>
            builtinConstraints;
    ...
    private static void validateField(List<ConstraintViolation> constraintViolations,
                                      ValidateProfile profile, CtField f, Object value) {
        Object[] annos = null;
        try {
            String fieldName = f.getName();
            ...
            for (Object o : annos) {
                ...
                List<Class<?>> constraintValidators =
                        (List<Class<?>>) builtinConstraints.get(anno.annotationType());
